...
/*
ApiOcmSmtpServiceV1SmtpDelete Delete an SMTP credential for a cluster
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param smtpDeleteRequest ClusterMeta data
@return ClusterMeta
*/
func (a *DefaultApiService) ApiOcmSmtpServiceV1SmtpDelete(ctx _context.Context, smtpDeleteRequest SmtpDeleteRequest) (ClusterMeta, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  ClusterMeta
	)
	...
	// body params
	localVarPostBody = &smtpDeleteRequest
